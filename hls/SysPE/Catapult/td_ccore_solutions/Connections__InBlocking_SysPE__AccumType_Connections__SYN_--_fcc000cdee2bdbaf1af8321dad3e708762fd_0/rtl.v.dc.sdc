...
set data_inputs [list do_wait_rsc_dat ccs_ccore_start_rsc_dat this_val {this_msg[*]}]
...
set_input_delay -clock [get_clocks {ccs_MIO_clk}] 0.0 [get_ports {do_wait_rsc_dat}]
