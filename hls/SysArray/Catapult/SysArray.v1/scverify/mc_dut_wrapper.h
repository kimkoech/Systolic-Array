...
// Generated date: Sun May 03 14:22:08 EDT 2020
//
// ----------------------------------------------------------------------------
...
typedef ccs_design::HDL::SysArray_rtl ccs_DUT_wrapper;
...
public:
   ...
   sc_in< sc_logic > act_in_vec_0_val;
   sc_in< sc_logic > act_in_vec_1_val;
   sc_in< sc_logic > act_in_vec_2_val;
   sc_in< sc_logic > act_in_vec_3_val;
   sc_in< sc_logic > act_in_vec_4_val;
   sc_in< sc_logic > act_in_vec_5_val;
   sc_in< sc_logic > act_in_vec_6_val;
   sc_in< sc_logic > act_in_vec_7_val;
   sc_out< sc_logic > act_in_vec_0_rdy;
   sc_out< sc_logic > act_in_vec_1_rdy;
   sc_out< sc_logic > act_in_vec_2_rdy;
   sc_out< sc_logic > act_in_vec_3_rdy;
   sc_out< sc_logic > act_in_vec_4_rdy;
   sc_out< sc_logic > act_in_vec_5_rdy;
   sc_out< sc_logic > act_in_vec_6_rdy;
   sc_out< sc_logic > act_in_vec_7_rdy;
   sc_in< sc_lv<8> > act_in_vec_0_msg;
   sc_in< sc_lv<8> > act_in_vec_1_msg;
   sc_in< sc_lv<8> > act_in_vec_2_msg;
   sc_in< sc_lv<8> > act_in_vec_3_msg;
   sc_in< sc_lv<8> > act_in_vec_4_msg;
   sc_in< sc_lv<8> > act_in_vec_5_msg;
   sc_in< sc_lv<8> > act_in_vec_6_msg;
   sc_in< sc_lv<8> > act_in_vec_7_msg;
