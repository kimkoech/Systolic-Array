...
solution options set /General/BranchOnChange {Never branch}
...
solution options set /Input/SearchPath {. ../../../matchlib/cmod/include ../../../matchlib/connections/include ../../../matchlib/rapidjson/include}
...
solution options set /Flows/VCS/VCS_HOME /cad/tools/synopsys/vcs-mx/L-2016.06-SP1-1
solution options set /Flows/VCS/VG_GNU_PACKAGE /cad/tools/synopsys/vcs-mx/L-2016.06-SP1-1/gnu/linux
solution options set /Flows/VCS/VG_ENV64_SCRIPT source_me.csh
solution options set /Flows/VCS/SYSC_VERSION 2.3.1
solution file add ../../../cmod/lab3/SysArray/SysArray.h -type CHEADER
solution file add ../../../cmod/lab3/SysArray/testbench.cpp -type C++ -exclude true
...
directive set -DESIGN_HIERARCHY SysArray
go compile
